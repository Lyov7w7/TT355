#include <iostream>#include <string>#include "LicenseManager.h"int main() {
std::cout << "==================================================" << std::endl;
...
int choice;
std::string userName;
int tempLicenseDays = 30; // Default 30 days for temporary licensesdo {
...
LicenseKey temp(manager.getCurrentMachineID(),
"Test User");
...
std::cout << "Temporary license duration updated to " << tempLicenseDays << " days.
" << std::endl;
}
else {
